#ifndef IMAGE_INTERACTION_SERVICE_INTERFACES_H
#define IMAGE_INTERACTION_SERVICE_INTERFACES_H
...
/**
 * @brief CTK服务接口前向声明文件（ImageInteraction插件）
 * 
...
#endif // IMAGE_INTERACTION_SERVICE_INTERFACES_H
